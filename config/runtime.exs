...
#
#     PHX_SERVER=true bin/phoenix_paper_website start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :phoenix_paper_website, PhoenixPaperWebsiteWeb.Endpoint, server: true
end
  ...
  config :phoenix_paper_website, PhoenixPaperWebsiteWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/phoenix_paper_website_web/router\.ex$"E,
        ~r"lib/phoenix_paper_website_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
